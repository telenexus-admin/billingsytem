...
// Defined early: expired-user and router-monitor blocks call these before the end of this file.
...
// Check for users on router with no active recharge
        ...
        foreach ($hotspotActive as $activeUser) {
            ...
            if (!$activeRecharge && !empty($activeUsername)) {
                ...
                try {
                    ...
                    echo "? Force disconnected hotspot user $activeUsername and cleared host entry\n";
                } catch (Exception $e) {
                        ...
                        try {
                            ...
                            if ($router) {
                                ...
                                if ($p['type'] == 'PPPOE') {
                                    ...
                                    // For hotspot users - existing code
                                    ...
                                    foreach ($cookies as $cookie) {
                                        if ($cookie->getProperty('user') == $c['username']) {
                                            ...
                                            echo "? Cleared hotspot cookie for {$c['username']}\n";
                                        }
                                    }
                                }
                            }
