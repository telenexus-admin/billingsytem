...
class MikrotikPppoe
{
    ...
    function description()
    {
        return [
            ...
            'description' => 'To handle connection between AlxSys with Mikrotik PPPOE',
            'author' => 'Connectx',
            'url' => [
                'Github' => 'https://github.com/Alxtexh/',
                'Whatsapp' => 'https://wa.link/njpgnq',
                'Profile' => 'https://alx.a21cash.com'
            ]
        ];
    }
