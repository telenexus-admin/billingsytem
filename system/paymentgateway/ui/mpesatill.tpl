            ...
            <div class="panel panel-primary panel-hovered panel-stacked mb30">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control" id="mpesa_consumer_secret" name="mpesa_till_consumer_secret" placeholder="xxxxxxxxxxxxxxxxx" value="{$_c['mpesa_till_consumer_secret']}">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-2 control-label">Business Shortcode(Store number/H.O)</label>
                        <div class="col-md-6">
                            <input type="text" class="form-control" id="mpesa_business_code" name="mpesa_till_business_code" placeholder="xxxxxxx" maxlength="7" value="{$_c['mpesa_till_business_code']}">
                        </div>
                    </div>
                      <div class="form-group">
					...
					<div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control" id="mpesa_pass_key" name="mpesa_till_pass_key" placeholder="bfb279f9aa9bdbcf158e97dd71a467cd2e0c893059b10f78e6b72ada1ed2c919" maxlength="" value="{$_c['mpesa_till_pass_key']}">
                        </div>
                    </div>
					<div class="form-group">
                        ...
                        <div class="col-md-6">
                            <select class="form-control" name="mpesa_till_env">
                                <option value="sandbox" {if $_c['mpesa_till_env'] == 'sandbox'}selected{/if}>Sandbox</option>
                                <option value="live" {if $_c['mpesa_till_env'] == 'live'}selected{/if}>Live</option>
                            </select>
