                    ...
                    <div class="box-body with-border">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" id="whatsapp_country_code_phone" placeholder="254"
                                    name="whatsapp_country_code_phone" value="{$_c['whatsapp_country_code_phone']}">
                            </div>
                            <span class="text-muted">if you put 254, Phone started with 0xxxx will change to 254xxxx</span>
                        </div>
                    </div>
                    <div class="box-footer">
                        <div class="row">
    ...
    <div class="row">
        ...
        <div class="col-md-8">
            ...
            <div class="bs-callout bs-callout-warning well">
                ...
                <span class="text-muted">Change Auth Basic Password will change secret. No need to change whatsapp URL in AllxSys with this. the plugin will work directly.</span>
            </div>
        </div>
    </div>
{/if}
