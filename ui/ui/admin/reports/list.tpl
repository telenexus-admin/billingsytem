...
<div class="bs-callout bs-callout-info bg-gray">
    <h4><i class="fa fa-info-circle"></i> {Lang::T('Information')}</h4>
    <p>
        <i class="fa fa-check-circle text-green"></i> {Lang::T('This report shows all transactions that occurred today.')}<br>
        <i class="fa fa-refresh text-blue"></i> {Lang::T('Click the Refresh button to see the latest transactions.')}<br>
        <i class="fa fa-print text-purple"></i> {Lang::T('Use Print or PDF buttons to export the report.')}
    </p>
</div>
