                    ...
                    <div class="box box-danger box-solid">
                        ...
                        <div class="box-body" style="font-size: larger;">
                            ...
                            <ul>
                                ...
                                <li>{Lang::T('Make sure your Mikrotik accessible from RaySys')}</li>
                            </ul>
                            {Lang::T('If you just update Raysys from upload files, try click Update')} Database
                        </div>
                        <div class="box-footer">
                            ...
                            class="btn btn-success btn-sm btn-block" style="color: black;">{Lang::T('Ask Dev team')}</a>
                            </div>
                            <br><br>
