    ...
    <div class="col-sm-6">
        ...
        <div class="box box-hovered mb20 box-primary">
            <div class="box-header">
                <h3 class="box-title">{Lang::T('Contribution')} AllxSys</h3>
            </div>
            <div class="box-body">
                <a href="https://github.com/allxsys/internet-management/graphs/contributors" target="_blank">
                    <img src="https://contrib.rocks/image?repo=allxsys/internet-management&columns=10" width="100%" />
                </a>
            </div>
        </div>
    </div>
        ...
        <div class="box box-hovered mb20 box-primary">
            ...
            <div class="box-footer">
                <div class="btn-group btn-group-justified" role="group" aria-label="...">
                    <a href="https://github.com/allxsys/internet-management/discussions" target="_blank"
                        class="btn btn-primary btn-sm btn-block"><i class="ion ion-chatboxes"></i> {Lang::T('Github
                        Discussions')}</a>
                    <a href="https://t.me/allxsys" target="_blank" class="btn btn-primary btn-sm btn-block"><i
...
<div class="row">
    ...
    <div class="col-sm-6">
        <div class="box box-hovered mb20 box-primary">
            ...
            <div class="box-body">
                {Lang::T('Your donation will help support and continue the development of AllxSys.')}
            </div>
            <div class="table-responsive">
                <table class="table table-bordered table-striped">
                    <tbody>
...
<div class="row">
    <div class="col-sm-6">
        ...
        <div class="box box-primary box-hovered mb20 activities">
            ...
            <div class="box-body">
                {Lang::T('Connect your AllxSys to WhatsApp efficiently using WhatsApp Gateway. Also, create Telegram bots easily and practically.')}
            </div>
            <div class="box-footer">
