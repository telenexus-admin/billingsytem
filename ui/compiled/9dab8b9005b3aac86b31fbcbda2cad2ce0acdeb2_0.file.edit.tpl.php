<?php
/* Smarty version 4.5.3, created on 2026-04-17 15:20:54
  from 'C:\Users\Administrator\Downloads\phpbilling sytem\ui\ui\admin\routers\edit.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.3',
  'unifunc' => 'content_69e225a6bbc251_35062580',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '9dab8b9005b3aac86b31fbcbda2cad2ce0acdeb2' => 
    array (
      0 => 'C:\\Users\\Administrator\\Downloads\\phpbilling sytem\\ui\\ui\\admin\\routers\\edit.tpl',
      1 => 1776361575,
      2 => 'file',
    ),
  ),
...
function content_69e225a6bbc251_35062580 (Smarty_Internal_Template $_smarty_tpl) {
    ...
    <div class="col-sm-12 col-md-12">
        <div class="panel panel-primary panel-hovered panel-stacked mb30">
            <div class="panel-heading">
                ...
                <?php echo Lang::T('Edit Router');?>

                <?php if ((isset($_smarty_tpl->tpl_vars['d']->value['status']))) {?>
                    <span class="router-status-badge <?php if ($_smarty_tpl->tpl_vars['d']->value['status'] == 'Online') {?>status-online<?php } else { ?>status-offline<?php }?>">
                        <i class="glyphicon glyphicon-<?php if ($_smarty_tpl->tpl_vars['d']->value['status'] == 'Online') {?>ok<?php } else { ?>remove<?php }?>" style="margin-right: 3px;"></i>
                        <?php if ($_smarty_tpl->tpl_vars['d']->value['status'] == 'Online') {
echo Lang::T('Online');
} else {
echo Lang::T('Offline');
}?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <label class="radio-inline">
                                <input type="radio" <?php if ($_smarty_tpl->tpl_vars['d']->value['enabled'] == 1) {?>checked<?php }?> name="enabled" value="1"> 
                                <span style="color: #22c55e;"><?php echo Lang::T('Enable');?>
</span>
                            </label>
                            <label class="radio-inline">
                                <input type="radio" <?php if ($_smarty_tpl->tpl_vars['d']->value['enabled'] == 0) {?>checked<?php }?> name="enabled" value="0">
                                <span style="color: #ef4444;"><?php echo Lang::T('Disable');?>
</span>
                            </label>
                        </div>
                    </div>
...
" placeholder="e.g., Downtown Tower">
                            <p class="help-block"><i class="glyphicon glyphicon-info-sign"></i> <?php echo Lang::T('Name of Area that router operated');?>
</p>
                        </div>
                    </div>
...
" onmouseleave="this.type = 'password'"
                            ...
                            <p class="help-block"><i class="glyphicon glyphicon-eye-open"></i> <?php echo Lang::T('Hover to reveal password');?>
</p>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <textarea class="form-control" id="description" name="description" 
                                placeholder="Describe the coverage area, location details, etc." rows="3"><?php echo $_smarty_tpl->tpl_vars['d']->value['description'];?>
</textarea>
                            <p class="help-block"><i class="glyphicon glyphicon-info-sign"></i> <?php echo Lang::T('Explain Coverage of router');?>
</p>
                        </div>
                    </div>
                            ...
                            <div class="form-group">
                        <label class="col-md-2 control-label"><?php echo Lang::T('Router Actions');?>
</label>
                        <div class="col-md-6">
                            <button type="button" class="btn btn-warning" onclick="testConnection()" id="test-connection-btn" style="margin-right: 5px;">
                                <i class="glyphicon glyphicon-signal"></i> <?php echo Lang::T('Test Connection');?>

                            </button>
                            <button type="button" class="btn btn-danger" onclick="rebootRouter()" id="reboot-btn">
                                <i class="glyphicon glyphicon-refresh"></i> <?php echo Lang::T('Reboot Router');?>
...
routers/list" class="btn-link" style="margin-left: 10px;">
...
: <?php echo $_smarty_tpl->tpl_vars['d']->value['name'];?>
            ...
            <div class="modal-body">
                <div class="alert alert-warning" style="background: #fef9c3; border-left: 4px solid #eab308; border-radius: 8px;">
                    ...
                    <strong><?php echo Lang::T('Warning!');?>
</strong> <?php echo Lang::T('This will reboot the router and disconnect all users.');?>
                ...
                <div class="form-group" style="margin-top: 15px;">
                    <label for="reboot-confirm" style="font-weight: 600; color: var(--primary-dark);">
                        ...
                        <?php echo Lang::T('Type "REBOOT" to confirm');?>
...
>
    ...
    function testConnection() {
        ...
        $.ajax({
            url: '<?php echo Text::url('');?>
routers/test-connection/' + routerId,
            method: 'GET',
            timeout: 5000,
